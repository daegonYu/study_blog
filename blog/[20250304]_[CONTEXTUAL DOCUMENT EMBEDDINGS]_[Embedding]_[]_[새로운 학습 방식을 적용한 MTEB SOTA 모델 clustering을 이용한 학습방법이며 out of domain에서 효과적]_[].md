...
2. 기존 biencoder 방식 대비 문맥을 반영하여 도메인 적응성이 향상됨

3. 문서 클러스터링 기반 contrastive loss를 적용하여 학습 효과를 극대화

4. 효율적인 Contextual Encoding 아키텍처 제안

5. 두 단계로 문서 임베딩을 생성하여 retrieval 성능을 향상시킴

6. Retrieval 모델을 도메인 특화 없이도 효과적으로 학습 가능
...
이 기법은 크게 두 단계로 나뉨:
1. M1 단계(주변 문서의 embedding을 계산하는 단계)
