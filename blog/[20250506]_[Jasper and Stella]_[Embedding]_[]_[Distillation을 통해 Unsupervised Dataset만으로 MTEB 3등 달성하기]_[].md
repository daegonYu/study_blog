...
![image](https://github.com/user-attachments/assets/5ef51b07-fe8d-49bf-83ca-f2291b44e5f0)
...
![image](https://github.com/user-attachments/assets/a187e75e-638d-4f82-90df-453c261090f6)
...
![image](https://github.com/user-attachments/assets/eec17b1d-87e7-4f75-bcbf-39462d551149)

> 최종 손실:
> 

![image](https://github.com/user-attachments/assets/64e7a37b-9e03-4c6c-9fc0-2adcd7cba74a)
...
- concat된 벡터가 12,288차원 → 실무 적용 어려움, 서빙 시 속도 이슈

**✅ 해결책**

- **Matryoshka Representation Learning** 기법 학습 : FC2, FC3, FC4로 각각 차원 축소 (예: FC3 → 512차원)

![image](https://github.com/user-attachments/assets/4db350c5-114b-47d2-8687-7ec99be25e77)

- cosine loss를 삭제한 이유는 맨 밑 질문사항 참고
...
- 이는 **"자기 자신 + 외부 teacher"로부터 지식을 증류**하는 Self-distil 전략
...
![image](https://github.com/user-attachments/assets/8f210bcb-d24e-43ac-b7e4-e88773e8e779)
...
- → 이 둘을 **concat하여 teacher 벡터로 사용**하면:
    - NV-Embed의 정보량
    - Stella의 안정성과 표현력을 **모두 distill 가능**
        

Stella를 teacher로 쓰는 건 "합리적이고 전략적인 선택"
